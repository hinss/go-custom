...
type DBConfig struct {
	...
	AllowNativePassword bool   `yaml:"allow_native_password"` // 是否允许native passowrd 加密，mysql8默认不允许
...
func (conf *DBConfig) FormatDsn() (string, error) {
	...
	driverConf := &mysql.Config{
		...
		AllowNativePasswords: conf.AllowNativePassword,
	}
