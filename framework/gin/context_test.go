...
import (
	...
	testdata "github.com/hinss/go-custom/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/hinss/go-custom/framework/gin.handlerNameTest$", c.HandlerName())
}
