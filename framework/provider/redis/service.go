...
// CustomRedis 代表Custom框架的redis实现
...
// NewCustomRedis 代表实例化Client
func NewCustomRedis(params ...interface{}) (interface{}, error) {
...
func (app *CustomRedis) GetClient(option ...contract.RedisOption) (*redis.Client, error) {
    // 读取默认配置
