...
// CustomRotateLog 代表会进行切割的日志文件存储
type CustomRotateLog struct {
	CustomLog
...
// NewCustomRotateLog 实例化CustomRotateLog
func NewCustomRotateLog(params ...interface{}) (interface{}, error) {
	// 参数解析
	...
	// 从配置文件中获取file信息，否则使用默认的Custom.log
	file := "notes.log"
