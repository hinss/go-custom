...
// NewCustomSingleLog params sequence: level, ctxFielder, Formatter, map[string]interface(folder/file)
func NewCustomSingleLog(params ...interface{}) (interface{}, error) {
